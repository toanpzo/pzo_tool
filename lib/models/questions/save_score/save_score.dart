...
class SaveScore with _$SaveScore {
  ...
  factory SaveScore({
    @HiveField(0) required int totalCorrect,
    @HiveField(1) required int totalWrong,
    @HiveField(2) required int dem,
  }) = _SaveScore;

  factory SaveScore.fromJson(Map<String, dynamic> json) =>
      _$SaveScoreFromJson(json);
}
