...
class _MyMenuState extends State<MyMenu> with SingleTickerProviderStateMixin {
  // @override
  // void initState() {
  //   TabItem t1=const TabItem(id: 1, title: "oi", icon: Icons.add);
  //   TabItem t2=const TabItem(id: 2, title: "oi", icon: Icons.add);
  //   TabItem t3=const TabItem(id: 3, title: "oi", icon: Icons.add);
  //   List<TabItem> items= List<TabItem>.empty(growable: true);
  //   items.add(t1);
  //   items.add(t2);
  //   items.add(t3);
  //   super.initState();
