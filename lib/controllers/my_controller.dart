...
class MyController {
  MyState? myState;
  final List<String>? keysToLoad;
  final Map<String, Future<void> Function()>? loadingFunctions;
  ...
  MyController(
    ...
    if (keysToLoad != null &&
      ...
      loadingFutures = {
        for (var key in keysToLoad!) key: loadingFunctions![key]!(),
      };
    } else {
      loadingFutures = {
        'default': loadDataFuture(),
      };
    }
  }
